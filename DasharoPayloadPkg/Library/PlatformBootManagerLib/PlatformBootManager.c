...
)
{
  ...
  STATIC UINT8 FtdiDevicePathRaw[] = {
    // PCI(14,0)
    0x02, 0x01, 0x0C, 0x00, 0x0D, 0x00, 0x00, 0x00,
    // USB(2,0)
    0x03, 0x05, 0x06, 0x00, 0x02, 0x00,
    // UART(115200,8,N,1)
    0x03, 0x0F, 0x13, 0x00, 0x00, 0xc2, 0x01, 0x00, 0x08, 0x00, 0x01, 0x00,
    // TtyTerm() = MSG_VENDOR_DP + gEfiTtyTermGuid
    0x03, 0x0A, 0x12, 0x00,   // Header
    0x80, 0x6d, 0x91, 0x7d,   // GUID.Data1
    0xb1, 0x5b,               // GUID.Data2
    0x8c, 0x45,               // GUID.Data3
    0xa4, 0x8f, 0xe2, 0x5f, 0xdd, 0x51, 0xef, 0x94, // GUID.Data4
    // End
    0x7F, 0xFF, 0x04, 0x00
  };
  EfiBootManagerUpdateConsoleVariable(ConOut, (EFI_DEVICE_PATH_PROTOCOL*)FtdiDevicePathRaw, NULL);
