...
)
{
  ...
  while (SecondsLeft > 0) {
    ...
    CreateMultiStringPopUp (
        ...
        L"!!! WARNING !!!",
        L"",
        L"This message is displayed, because the platform booted in Firmware",
        L"Update Mode. All firmware write protections are disabled in this mode.",
        L"If you plan to update firmware, press key listed below to continue,",
        L"otherwise press any other key or wait for the timeout.",
        L"",
        PressKeyLine,
        L"",
        L"(The platform will reboot and disable Firmware Update Mode",
        DelayLine
        );
